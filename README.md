...
> [!WARNING]
> **Storage Network Mods:** Do not connect multiple Vault I/O blocks pointing to the same vault to the same storage network (AE2, RS, Tom's). Overlapping items will be counted multiple times by the network, causing visual duplication and broken autocrafting jobs due to ghost ingredients.
...
| 26.1.2    | 0.148.0+26.1.2     | 26.1.2.99+      |
